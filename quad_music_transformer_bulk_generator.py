...
Original file is located at
    https://colab.research.google.com/github/asigalov61/Quad-Music-Transformer/blob/main/Model/Quad_Music_Transformer_Bulk_Generator.ipynb
...
if try_to_generate_outro:
  outy.extend([2448, 2448, 2448, 2448])
